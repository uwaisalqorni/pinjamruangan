...
flatpickr("#tanggal_waktu", {
    enableTime: true,
    dateFormat: "d/m/Y H:i", // Format 24 jam
    time_24hr: true
});
</script>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="arteri-main-menu">
                <ul class="nav navbar-nav">
					...
					if (isset($_SESSION['akses_modul']['pinjamruangan']) && $_SESSION['akses_modul']['pinjamruangan'] == 'on') {
						echo '<li><a href="' . site_url('/pinjamruangan') . '"><i class="glyphicon glyphicon-folder-open"></i> Pinjam Ruangan</a></li>';
					}
